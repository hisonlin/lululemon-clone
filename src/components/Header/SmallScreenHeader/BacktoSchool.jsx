...
import {Box, Typography, IconButton, List, ListItem, ListItemText, Button, Collapse} from '@mui/material';
...
const BacktoSchool = ({onBack, onClose}) => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh', width: '100%', maxWidth: '1200px' }}>
      <Box sx={{ display: 'flex', alignItems: 'center', p: '0.3rem 1rem', borderBottom: 1, borderColor: 'divider' }}>
        ...
        <Typography variant="h6" sx={{ flexGrow: 1, fontWeight: 500 }}>Back To School</Typography>
      ...
      <Box sx={{ overflow: 'auto' }}>
        <List sx={{borderBottom:1, borderColor:'divider'}}>
          <ListItem>
            <ListItemText primary="Back To School" primaryTypographyProps={{fontWeight: 'medium', fontSize: '1.2rem'}}/>
        ...
        <Typography variant="subtitle1" sx={{ px: 2, py: 1, fontWeight: '400' }}>Shop Back To School</Typography>
        <Box sx={{p: '0 1rem', borderBottom: 1, borderColor: 'divider', mb: 1}}>
          <RoundedImage src="/backpack.webp" alt="Back to School backpack"/>
          <Typography variant="h6" gutterBottom fontWeight="bold">
            Busy school days? Bring it.
          </Typography>
          <Button
